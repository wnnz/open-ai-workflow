...
describe('AgentConfigPanel', () => {
  it('adds a workspace script as an agent tool', async () => {
    ...
    const wrapper = mount(AgentConfigPanel, { props: { config, providers: [], scripts: [{ id: 's1', name: 'Search Script' }], variableGroups: [] }, global: { plugins: [i18n, [PrimeVue, { unstyled: true }]] } })
