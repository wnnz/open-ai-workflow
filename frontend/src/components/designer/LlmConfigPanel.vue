  ...
  <section class="mt-5 space-y-5">
    ...
    <section class="rounded-lg border border-[var(--border)] bg-[var(--panel-subtle)] p-3">
      ...
      <div v-if="config.vision.enabled" class="mt-3 space-y-3 border-t border-[var(--border)] pt-3">
        <label class="field-label">{{ t('designer.imageVariable') }}<VariableField v-model="config.vision.variable" class="mt-1.5 font-mono" :groups="variableGroups" placeholder="{{inputs.images}}" /></label>
