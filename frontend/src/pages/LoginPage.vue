...
<template>
  <div class="relative flex min-h-screen items-center justify-center overflow-hidden bg-[var(--app-bg)] p-6">
    <div class="absolute left-6 top-5 flex items-center gap-2 text-lg font-bold"><span class="flex h-8 w-8 items-center justify-center rounded-xl bg-[var(--primary)] text-white">O</span>Open Workflow</div>
